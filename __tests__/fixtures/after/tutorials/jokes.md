...
<docs-info>💿 Hello, I'm Rachel the Remix Disc. I'll show up whenever you have to actually *do* something.</docs-info>
...
To *load* data in a Remix route module, you use a [`loader`][loader]. This is simply an `async` function you export that returns a response, and is accessed on the component through the [`useLoaderData`][use-loader-data] hook. Here's a quick example:
...
💿 Update .env file with SESSION\_SECRET (with any value you like).
